...
ProjectSchema = folder.ATFolderSchema.copy() + atapi.Schema((
    ...
    atapi.ReferenceField('generic_provider',
                         relationship='generic_provider',
                         allowed_types=('Provider',),
                         widget=ReferenceBrowserWidget(label='Generic provider',
                                                       description='Generic provider for this project (chose EUDAT Ltd if in doubt)',
                                                       allow_browse=1,
